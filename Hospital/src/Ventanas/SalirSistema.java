...
public class SalirSistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("¡Gracias por usar el Sistema de Gestión Hospitalaria!");
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SalirSistema.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
